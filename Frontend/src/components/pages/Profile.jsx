...
import { FaUser, FaCalendarAlt, FaClock, FaUsers, FaVideo, FaComment } from 'react-icons/fa';
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {meetings.map((meeting) => (
              <motion.div
                key={meeting.meetingID._id} // Use meetingID._id since history is an array of { meetingID }
              ...
              >
                ...
                {/* Participants count not available in history response, fetch in details */}
              </motion.div>
            ))}
          </div>
        </motion.div>
            ...
            >
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-white">{selectedMeeting.meeting_id}</p>
                </div>
                <div>
